   <!-- Main header start -->
   <header
      class="main-header navbar-fixed-top header-transparent sticky-header"
    >
      <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light">
          <a class="navbar-brand logo" href="index.html">
            <h3 class="text-primary">JOBB</h3>
          </a>
          <button
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav header-ml">
              <li class="nav-item dropdown active">
                ...
                <ul
                  class="dropdown-menu dm-2"
                  aria-labelledby="navbarDropdownMenuLink"
                >
                  <li>
                    <a class="dropdown-item" href="index.html">Index 01</a>
                  </li>
                  <li>
              ...
              <li class="nav-item dropdown">
                ...
                >
                  <li>
                    <a class="dropdown-item" href="candidate-list.html"
                      >Candidate Listing</a
                    >
                  </li>
                  <li>
                    <a class="dropdown-item" href="candidate-details.html"
                      >Candidate Details</a
                    >
                  </li>
                  <li>
                  ...
                  <li class="dropdown-submenu" id="candidates">
                    <a class="dropdown-item" href="#">Candidate Dashboard</a>
                    <ul class="dropdown-menu dm-2" id="candidates-options">
                      <li>
                      ...
                      <li>
                        <a class="dropdown-item" href="bookmark.html"
                          >bookmark</a
                        >
                      </li>
                      <li>
                        <a class="dropdown-item" href="applied.html">Applied</a>
                      </li>
                      <li>
              ...
              <li class="nav-item dropdown">
                ...
                >
                  <li>
                    <a class="dropdown-item" href="employer-list.html"
                      >Employer Listing</a
                    >
                  </li>
                  <li>
                    <a class="dropdown-item" href="employer-details.html"
                      >Employer Details</a
                    >
                  </li>
                  <li>
                  ...
                  <li class="dropdown-submenu" id="employer">
                    <a class="dropdown-item" href="#">Employer Dashboard</a>
                    <ul class="dropdown-menu dm-2" id="employer-options">
                      <li>
              ...
              <li class="nav-item dropdown">
                ...
                >
                  <li>
                    <a class="dropdown-item" href="job-list.html"
                      >Job Listing</a
                    >
                  </li>
                  <li>
                    ...
                    <div class="row sobuz">
                      <div class="col-sm-4 col-md-4 col-lg-4">
                        <div class="megamenu-section">
                          ...
                          >
                          <a class="dropdown-item" href="how-it-work.html"
                            >How It Work</a
                          >
                          <a class="dropdown-item" href="invoices.html"
                            >Invoice</a
                          >
                        </div>
                      </div>
              ...
              <li class="nav-item dropdown">
                ...
                >
                  <li>
                    <a class="dropdown-item" href="blog-columns-1.html"
                      >Blog 1 Columns</a
                    >
                  </li>
                  <li>
                    <a class="dropdown-item" href="blog-columns-2.html"
                      >Blog 2 Columns</a
                    >
                  </li>
                  <li>
                    <a class="dropdown-item" href="blog-columns-3.html"
                      >Blog 3 Columns</a
                    >
                  </li>
                  <li>
