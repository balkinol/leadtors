      ...
      <div class="container">
        <div class="row">
                ...
                <form method="GET" class="informeson">
                  <div class="form-group">
                    ...
                    <input
                      type="text"
                      name="search"
                      class="form-control selectpicker search-fields"
          ...
          <div class="col-xl-8 col-lg-8 col-md-12">
            <!-- Option bar start -->
            <div
              class="option-bar d-none d-xl-block d-lg-block d-md-block d-sm-block"
            >
              <div class="row bar">
                <div class="col-lg-6 col-md-7 col-sm-7">
                  <div class="sorting-options2 mr-auto">
                ...
                <div class="col-lg-6 col-md-5 col-sm-5">
                  <div class="sorting-options ml-auto">
